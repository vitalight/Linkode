...
<%@ include file="../modules/header.jsp"%>
	...
	<div class="display margin-top">
		<form action="${pageContext.request.contextPath}/ad/create" method="post" enctype="multipart/form-data">
			<div class="display-bar more-padding create-bar">
				<div class="row">
					<input class="form-control" name="id" value="${model.id}" type="hidden" />
					<div class="col-sm-4">
						广告标题：<input class="form-control" type="text" name="title" required/>
					</div>
					<div class="col-sm-4 col-sm-offset-2">
						广告网站：<input class="form-control" type="text" name="content" required/>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4">
						<fmt:formatDate pattern="yyyy-MM-dd" value='${model.startDate}' var="time"/>
						开始日期：<input class="form-control" type="date" name="startDate" required/>
					</div>
					<div class="col-sm-4 col-sm-offset-2">
