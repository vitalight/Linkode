...
<c:set var="type" value="post"/><c:set var="headType" value="admin"/><%@ include file="./crud-head.jsp" %>
<div class="panel panel-default display bigger">
<div class="panel-heading">
post<button class="btn btn-default" type="button" id="add">
<i class="fa fa-plus"></i></button></div> <!-- /.panel-heading -->
<div class="panel-body"><div class="dataTable_wrapper">
<table class="table table-striped table-bordered table-hover" id="dataTables">
<thead><tr>
<th>id</th><th>type</th><th>title</th><th>content</th><th></th></tr></thead><tbody>
<c:forEach items="${model}" var="post">
<tr>
<td>${post.id}</td><td>${post.type}</td><td>${post.title}</td><td>${post.content}</td><td><button class="btn btn-default delete" type="button" data-id="${post.id}">
...
<script src="${pageContext.request.contextPath}/static/js/crud/post.js"></script>
